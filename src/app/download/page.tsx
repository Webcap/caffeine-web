    ...
    <main style={{ minHeight: "100vh" }}>
      ...
      <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: "2rem", alignItems: "center" }}>
          <Link href="/" style={{ fontSize: "0.9rem", color: "var(--primary)", fontWeight: 700 }}>Watch Now</Link>
          {flags.enable_ott && (
      ...
      <section style={{ 
        ...
        <div className="animate-fade-in" style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center" }}>
            <Link href="/" className="btn-primary glow-pulse" style={{ padding: "12px 32px" }}>Start Watching Now</Link>
            <a href="#download" className="btn-secondary" style={{ padding: "12px 32px" }}>Get App</a>
          </div>
        </div>
